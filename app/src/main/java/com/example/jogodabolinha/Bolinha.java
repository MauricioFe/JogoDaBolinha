...
public class Bolinha {
    ...
    public Bolinha(Context context) {
        ...
        Drawable drawable = res.getDrawable(R.drawable.ic_ball);
        mImgBolinha = drawableToBitmap(drawable);
    }
    ...
    public void setTamanhoDeTela(int w, int h) {
        mLarguraTela = w;
        mAlturaTela = h;
    }
